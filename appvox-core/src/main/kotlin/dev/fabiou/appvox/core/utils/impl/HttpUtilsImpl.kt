package dev.fabiou.appvox.core.utils.impl
...
object HttpUtilsImpl : HttpUtils {

    private const val URL_FORM_CONTENT_TYPE = "application/x-www-form-urlencoded"

    override fun getRequest(requestUrl: String, bearerToken: String?, proxyConfig: ProxyConfiguration?) : String {
    ...
    override fun postRequest(requestUrl: String, requestBody: String, configuration: ProxyConfiguration?) : String {
        var response: String = ""
