...
internal class AppStoreReviewRepository(
...
) : ReviewRepository<AppStoreReviewRequest, AppStoreReviewResult> {
    companion object {
    ...
    override fun getReviewsByAppId(request: AppStoreReviewRequest): ReviewResult<AppStoreReviewResult> {
        ...
        return ReviewResult(result = result, nextToken = result.next)
    }
}